...
*Parameters*: Here are the parameters required by the `games` method:

- year: an integer value representing the calendar year for which you would like to retrieve game data.
...
*Parameters*: Here are the parameters required by the `players` method:

- id: a long value representing the id for which you would like to retrieve player data.
